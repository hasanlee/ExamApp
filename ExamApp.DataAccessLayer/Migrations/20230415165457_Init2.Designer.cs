...
namespace ExamApp.DataAccessLayer.Migrations
{
    ...
    [Migration("20230415165457_Init2")]
    partial class Init2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExamApp.EntityLayer.Entities.Exam", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 4, 15, 20, 54, 57, 613, DateTimeKind.Local).AddTicks(1031),
                            ExamDate = new DateTime(2023, 4, 15, 20, 54, 57, 613, DateTimeKind.Local).AddTicks(1032),
                            IsDeleted = false,
                            LessonId = 1,
                            Mark = 5m,
                            StudentId = 1
            ...
            modelBuilder.Entity("ExamApp.EntityLayer.Entities.Lesson", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClassNo = 1m,
                            CreatedAt = new DateTime(2023, 4, 15, 20, 54, 57, 613, DateTimeKind.Local).AddTicks(2644),
                            IsDeleted = false,
                            LessonNo = "L01",
                            Name = "Lesson 1",
                            TeacherName = "John",
            ...
            modelBuilder.Entity("ExamApp.EntityLayer.Entities.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClassNo = 1m,
                            CreatedAt = new DateTime(2023, 4, 15, 20, 54, 57, 613, DateTimeKind.Local).AddTicks(4311),
                            IsDeleted = false,
                            Name = "Albert",
                            StudentNo = 12m,
                            Surname = "Einstein"
